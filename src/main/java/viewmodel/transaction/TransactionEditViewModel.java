...
public class TransactionEditViewModel {
    ...
    public void setTransaction(final Transaction transaction) {
        ...
        transaction.getName().ifPresent(this.getNameProperty()::setValue);
        transaction.getSource().ifPresent(source -> this.getSourceProperty().setValue(AccountListView.of(source)));
        transaction.getSink().ifPresent(sink -> this.getSinkProperty().setValue(AccountListView.of(sink)));
        transaction.getAmount().ifPresent(amount -> this.currencyProperty.setValue(amount.getCurrency().getCurrencyCode()));
        transaction.getAmount().ifPresent(amount -> this.amountProperty.setValue(amount.getNumber().toString()));
        transaction.getDate().ifPresent(date -> this.dateProperty.setValue(LocalDate.ofEpochDay(date)));
    }
